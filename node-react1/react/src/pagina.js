...
class Pagina extends Component {
  ...
  listar = async ( _evento = null )=> {
    if (_evento) {
      _evento.preventDefalult();
    }
    const { entidad } = this.props;
    const { columnas,search } = this.state;
  ...
  render() {
    ...
    return (
      <>
        <ActionsMenu cambiarModal={this.cambiarModal} titulo={titulo} manejarsearchInput={this.manejarsearchInput} />
        <Tabla
          entidades={entidades}
